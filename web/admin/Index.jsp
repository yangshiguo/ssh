...
<% if (null != admin) { %>
	...
	<div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>SSH2 <small>基于Struts2+Spring+Hibernate技术构建</small></h1>
            <ol class="breadcrumb">
	              ...
	              <div class="panel-heading">
	                <div class="row">
	                  ...
	                  <div class="col-xs-6 text-right">
	                    ...
	                    <p class="announcement-heading"><s:property value="counter"/></p>
	            ...
	            <div class="panel panel-success">
	              <div class="panel-heading">
	                <div class="row">
	                  ...
	                  <div class="col-xs-6 text-right">
	                    <p class="announcement-heading"><s:property value="articleCount"/></p>
            ...
            <div class="panel panel-warning">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><s:property value="cmtCount"/></p>
            ...
            <div class="panel panel-danger">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><s:property value="userCount"/></p>
