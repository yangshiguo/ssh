...
<body>
    ...
    <div class="container "> 
    	...
    	<form class="form-horizontal" name="add_category_form" action="<%=basePath %>category/add?userId=<%=u.getId() %>" method="post" onsubmit="return isValidate(add_category_form)">
    	<div class="col-md-6">
