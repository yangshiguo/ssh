	    ...
	    <div id="myTabContent" class="tab-content">
	      <div class="tab-pane active in" id="home">
	        <form class="form-horizontal" name="profile_form" role="form" id="tab" action="<%=basePath %>user/updateprofile?userId=<%=u.getId() %>" method="post" onsubmit="return isValidate(profile_form)">
	            ...
	            <input class="form-control" type="text" name="pf.firstName" value="<s:property value="pf.firstName"/>"> 
	           	
	            </div>
	            <div class="form-group">
	            <label for="last_name">名</label>
	            
	            <input class="form-control" type="text" name="pf.lastName" value="<s:property value="pf.lastName"/>">
	           
	            </div> 
	            <div class="form-group">
	            <label for="telephone">手机号码</label>
	           
	            <input class="form-control" type="text" name="pf.telephone" value="<s:property value="pf.telephone"/>">
	            <input type="hidden" name="pf.user.id" value="<s:property value="pf.user.id"/>">
	            <input type="hidden" name="pf.id" value="<s:property value="pf.id"/>">
	            </div>
	            <div class="form-group">
	            <label for="gender">性别</label>
	            <select class="form-control" name="pf.strGender" id="gender" >
	      ...
	      <div class="tab-pane fade" id="profile">
	    	<form class="form-horizontal" id="tab2" name="updatePwd" onsubmit="return isPasswordValidate(updatePwd)" 
	    	      method="post" action="user/updatepass?userId=<%=u.getId() %>">
	        	<div class="form-group">
