...
<body>
   ...
   <div class="container">
    <div class="row">
		<div class="col-md-6">
			<form name="login_form" class="form-horizontal" action='admin/login' method="POST" onsubmit="return isValidate(login_form)">
			  <fieldset>
			    <div id="legend">
			    ...
			    <div class="form-group">
			      ...
			      <label for="username">用户名</label>
                   <input class="form-control" type="text" id="username" name="admin.username" placeholder="请输入用户名" >
			    </div>
			    <div class="form-group">
			      <!-- Password-->
			      <label  for="password">密码</label>		      
			        <input class="form-control" type="password" id="password" name="admin.password" placeholder="请输入密码" >
			    </div>
			    <div class="form-group">
			      <!-- Button -->		     
